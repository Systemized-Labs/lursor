...
/** A row of one-tap values — resolutions, here. */
      ...
      {options.map((option) => {
        ...
        return (
          <button
            ...
            onClick={() => onChange(option.value)}
            className={cn(
              "rounded-full border px-2.5 py-1 text-xs font-medium outline-none ring-ring transition-colors focus-visible:ring-2",
              selected
