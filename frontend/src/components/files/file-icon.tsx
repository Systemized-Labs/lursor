...
const EXT_KINDS: Record<string, FileKind> = {
  ...
  avif: { Icon: Image, label: "Image" },
  bmp: { Icon: Image, label: "Image" },
  ico: { Icon: Image, label: "Icon" },
  mp4: { Icon: FileVideo, label: "Video" },
  m4v: { Icon: FileVideo, label: "Video" },
  mov: { Icon: FileVideo, label: "Video" },
  webm: { Icon: FileVideo, label: "Video" },
  ogv: { Icon: FileVideo, label: "Video" },
  mkv: { Icon: FileVideo, label: "Video" },
  avi: { Icon: FileVideo, label: "Video" },
  mp3: { Icon: FileAudio, label: "Audio" },
  wav: { Icon: FileAudio, label: "Audio" },
  ogg: { Icon: FileAudio, label: "Audio" },
  oga: { Icon: FileAudio, label: "Audio" },
  opus: { Icon: FileAudio, label: "Audio" },
  m4a: { Icon: FileAudio, label: "Audio" },
  aac: { Icon: FileAudio, label: "Audio" },
  flac: { Icon: FileAudio, label: "Audio" },
  weba: { Icon: FileAudio, label: "Audio" },
}
